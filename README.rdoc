=RBlog. Yet another Ruby on Rails blog engine
...
===How to install RBlog?
First you need server with Rails-2.3.4 or later.
Clone RBlog from GitHub

    git clone git://github.com/igor-alexandrov/rblog.git

It will make a directory called "rblog" on your hard disk. Got into it. Now you should prepare your database. Just copy /config/database_sample.yml as database.yml
...
Tables are ready, just put some initial values in them.
...
That is all, you can see your blog at localhost:3000. Admin section is located at /admin, default user is "admin" and password is "admin" too.
Enjoy!
