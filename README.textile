...
* Link; link is a small post, that points to some other resource in Internet. Link has a description (length of description can be set in config.yml file) and url.
It is very useful, when you want to save some interesting material or make a cross-posting.

It is very easy to add new type of content to RBlog. And in some upcoming releases we will add some new types. If you have any offers, contact us please.

h4. RBlog is fast and powerful.
