...
That is all, you can see your blog at `localhost:3000`. Admin section is located at `localhost:3000/admin`, default user is "__admin__" and password is "__admin__" too.
Enjoy!
