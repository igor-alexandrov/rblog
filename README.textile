...
It will make a directory called @rblog@ on your hard disk. Got into it. Now you should prepare your database. Just copy @config/database.yml.example@ as @config/database.yml@
